...
<html>
    ...
    <header id="header">
        ...
        <br><br>
        <h3>¡Ups, no te has registrado!</h3>
        <br><br>
        <p>Para adoptar una mascota, debes registrarte. 
           Si ya posees una cuenta, inicia sesión.</p>
        <img src="Styles/CUteeee.gif" alt="gatito" style="width:250px;height:250px"/>
        <br><br>
    </body>
    <footer id="footer">  
        <div class="copyright">
